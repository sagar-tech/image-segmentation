...
PATH_TO_LABELS = os.path.join('inference_graph_mask_rcnn', 'labelmap.pbtxt')
                ...
                if proceed == "True":
                    ...
                    try:
                        for image_path in TEST_IMAGE_PATHS:
                            ...
                            vis_util.visualize_boxes_and_labels_on_image_array(image_np,output_dict['detection_boxes'],output_dict['detection_classes'],output_dict['detection_scores'],category_index,instance_masks=output_dict.get('detection_masks'),line_thickness=0,use_normalized_coordinates=True,skip_scores=True,skip_labels=True)
                    ...
                    # Extracting classes and scores from detection with minumum threshold=60%
                    try:
                        ...
                        for i in range(len(dicta)):
                            ...
                            scr1 = float(scr1) * 100
                            if cls[i] == 1:
                                out1 = "vegetation (" + str(scr1) + ")% CONFIDENCE"
                                out_str += out1 + "\n"

                            if cls[i] == 2:
                                out2 = "land (" + str(scr1) + ")% CONFIDENCE"
                                out_str += out2 + "\n"

                            if cls[i] == 3:
                                out3 = "waterbody (" + str(scr1) + ")% CONFIDENCE"
                                out_str += out3 + "\n"

                            if cls[i] == 4:
                                 out4 = "building (" + str(scr1) + ")% CONFIDENCE"
                                 out_str += out4 + "\n"
                        # return string to the show_image.html page
                        print(out_str)
                        filepath = os.getcwd() + "\\static\\masked_image\\"+filename
                        print(filepath)
                        return render_template('show_image.html', out_str=out_str)
                        # if len(dicta) == 1:
                        #     print("1 class detected.......", cls)
                        #     if cls[0] == 1:
                        #         out_str = out1
                        #
                        #     if cls[0] == 2:
                        ...
                        #
                        # if len(dicta) == 3:
                        #     print("3 class detected..........", cls)
                        #     if (cls[0]==1) & (cls[1]==2) & (cls[2]==3):
                        #         out_str = out1 + " , " + out2 + " , " + out3
                        #
                        #     if (cls[0]==1) & (cls[1]==2) & (cls[2]==4):
                        #         out_str = out1 + " , " + out2 + " , " + out4
                        #
                        #     if (cls[0]==1) & (cls[1]==3) & (cls[2]==4):
                        #         out_str = out1 + " , " + out3 + " , " + out4
                        #
                        #     if (cls[0]==2) & (cls[1]==3) & (cls[2]==4):
                        #         out_str = out2 + " , " + out3 + " , " + out4
                        #
                        #     return render_template('show_image.html', out_str=out_str)
                        #
                        #
                        # if len(dicta) == 4:
                        #     print("4 class detected...................")
                        #     out_str = out1 + " , " + " , " + out4
                        #     return render_template('show_image.html', out_str=out_str)
